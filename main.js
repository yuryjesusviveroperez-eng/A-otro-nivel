...
import { suscribirseAEstadisticas, suscribirseAImagenes } from "./data.js";
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  suscribirseAImagenes(datos => {
    aplicarImagen('imagenHero', datos.Hero);
    aplicarImagen('imagenTalento1', datos.Talento1);
    aplicarImagen('imagenTalento2', datos.Talento2);
    aplicarImagen('imagenTalento3', datos.Talento3);
  });
});
